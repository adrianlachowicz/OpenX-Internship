...
def parse_args():
    ...
    parser = ArgumentParser(
        description="The script trains a 'Decision Tree' classifier. "
...
def train_model(data_path: str, model_filename: str):
    """
    The function trains a specific model (in this case DecisionTreeClassifier), calculates accuracy and saves it.
